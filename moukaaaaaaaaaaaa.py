...
try:
    ...
    pass  # __file__ not available on Streamlit Cloud; secrets come from st.secrets
...
def create_jwt(nom: str, prenom: str, email: str) -> str:
    ...
    return jwt.encode(payload, str(JWT_SECRET), algorithm="HS256")


def verify_jwt(token: str):
    try:
        return jwt.decode(token, str(JWT_SECRET), algorithms=["HS256"])
